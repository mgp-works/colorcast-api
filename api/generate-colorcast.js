...
export default async function handler(req, res) {
  res.setHeader("Access-Control-Allow-Origin", "https://mgp.works");
      ...
      messages: [
        {
          ...
          Return:
          - a one-line fortune in English (absurd, funny, and oddly specific — e.g., "Watch out for pigeon poop today")
          ...
          Format:
          {
            "fortune": "Watch out for pigeon poop today",
